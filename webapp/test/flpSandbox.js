		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Walkthrough",
									"targetURL": "#comdemowalkthroughwalkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemowalkthroughwalkthrough-display": {
								"semanticObject": "comdemowalkthroughwalkthrough",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.walkthrough.walkthrough",
									"url": sap.ui.require.toUrl("com/demo/walkthrough/walkthrough")
								}
							}
						}
					}
